...
public:
  ...
  [[nodiscard]] virtual auto get_height() const -> uint64_t = 0;
  [[nodiscard]] virtual auto get_depth() const -> uint32_t = 0;
  ...
  virtual auto get_acceleration_structure_handle() -> uint64_t = 0;
